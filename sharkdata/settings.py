...
FILENAME_PATTERN_ID_INSTITUTE = "INSTITUTE"
...
EXPORTFORMATS_FILENAME_PATTERN = [
    "<FORMAT>_<INSTITUTE>_<DATATYPE>_<YEAR>_TEST_version_<GENERATED>.<FILETYPE>",
    "<FORMAT>_<INSTITUTE>_<DATATYPE>_<YEAR>_version_<GENERATED>.<FILETYPE>",
    "<FORMAT>_<INSTITUTE>_<DATATYPE>_TEST_version_<GENERATED>.<FILETYPE>",
    "<FORMAT>_<INSTITUTE>_<DATATYPE>_version_<GENERATED>.<FILETYPE>"
]
...
SHARKDATA_DATA_IN_EXPORTFORMATS = pathlib.Path(
    SHARKDATA_DATA_IN, EXPORTFORMATS_FOLDER_NAME
)
