...
class DataFileInfo(object):
    ...
    def __init__(self, directory_path, file_name):
        ...
        self.file_info = FileInfo.create(self.directory_path, 
                                         self.file_name,
                                         self.name,
                                         self.version,
                                         self.datatype,
...
class ExportFileInfo(DataFileInfo):
    ...
    def _set_variables_from_filename(self):
        pattern_values = string_utils.extract_pattern_values(self.file_name, 
        ...
        self.log_file = os.path.splitext(self.file_name)[0] + settings.EXPORTFORMATS_LOG_FILENAME_ENDING
